...
export default {
    ...
    http.get(url).then(response => {
      ...
      for(let i=0; i<this.achievements.length; i++){
        ...
        link = link.slice(0, -1);
        let tanggal_str = new Date(this.achievements[i].updatedAt);
        this.achievements[i].tanggal = tanggal_str.getDate();
        this.achievements[i].bulan = this.months[tanggal_str.getMonth()];   
        this.achievements[i].tahun = tanggal_str.getFullYear(); 
